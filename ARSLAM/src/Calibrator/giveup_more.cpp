...
#include "C:\OpenCV2.0\include\opencv\cvaux.h"
#include "C:\OpenCV2.0\include\opencv\cxcore.h"
#include "C:\OpenCV2.0\include\opencv\cxtypes.h"
...
int main(int argc, char* argv[]) 
{
	...
	CvCapture* capture = cvCreateCameraCapture( 0 );//0 for logitech 1 for hp
	assert( capture );
